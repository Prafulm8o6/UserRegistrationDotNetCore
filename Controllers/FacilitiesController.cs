...
namespace UserRegistrationDotNetCore.Controllers
{
    public class FacilitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] Facility facility)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description")] Facility facility)
        {
            if (id != facility.Id)
            {
                return NotFound();
